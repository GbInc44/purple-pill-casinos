...
const affiliateUrl = "https://mrbit.bg/bg";
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8 py-8">
        ...
        <header className="mt-8 mb-6 text-center">
          ...
          >
            <p>
              Mr Bit е сред най-популярните онлайн букмейкъри и казина в България, предлагащ
              богато разнообразие от спортни залози, конкурентни коефициенти и модерна платформа
              за залагане. Онлайн казиното впечатлява с удобен интерфейс, бърза навигация и
              мобилно приложение, което позволява лесен достъп до всички функции от всяко
              устройство. Благодарение на лицензираната си дейност, сигурната среда и
              разнообразните възможности за игра, Mr Bit се утвърждава като предпочитан избор
              сред българските любители на онлайн залозите. Комбинацията от спортни пазари,
              казино игри и атрактивни промоции прави Mr Bit една от най-актуалните платформи
              за онлайн залагания.
            </p>
          </div>
        </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] gap-5">
            ...
            >
              <div className="h-32 sm:h-36 w-full rounded-xl flex items-center justify-center overflow-hidden border border-white/10" style={{ backgroundColor: "#0d1b3d" }}>
                <img src={mrbitLogo} alt="MrBit — лого" className="h-full w-full object-contain" />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 content-start">
              ...
              <InfoTile icon={Gift} label="Начален бонус" hue={20}>
                <div className="space-y-1 text-sm">
                  <div className="font-bold">до 1000 € + до 100 FS</div>
                  <a
                    href="#bonuses"
                    onClick={(e) => {
                      e.preventDefault();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 text-white text-sm">
                ...
                <a href="mailto:support@mrbit.bg" className="hover:underline">support@mrbit.bg</a>
              </div>
              <div className="flex items-center gap-3 text-white text-sm">
        ...
        <section id="bonuses" className="mt-12 mb-8">
          ...
          >
            ...
            >
              Готови ли сте за MrBit?
            </h2>
            <p className="text-white/85 mb-5">
              Начален бонус до 1000 € + до 100 FS. Регистрирайте се през нашия линк.
            </p>
            <a
              href={affiliateUrl}
              target="_blank"
