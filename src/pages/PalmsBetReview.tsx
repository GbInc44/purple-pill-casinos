    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        <header className="mt-8 mb-6 text-center">
          <h1
            className="font-extrabold text-3xl md:text-5xl text-white font-['Orbitron'] tracking-wide"
            style={{ textShadow: "0 0 12px hsla(270,100%,65%,0.7), 0 0 40px hsla(270,100%,65%,0.4)" }}
          >
            Ревю на Palms Bet
          </h1>
          <p className="mt-3 max-w-3xl mx-auto text-white/85 text-base md:text-lg leading-relaxed">
        ...
        <section id="payments" className="mt-12">
          ...
          <p className="text-white/80 text-sm md:text-base leading-relaxed mb-6 max-w-4xl">
